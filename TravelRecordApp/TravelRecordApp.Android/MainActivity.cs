...
namespace TravelRecordApp.Droid
{
    ...
    public class MainActivity : global::Xamarin.Forms.Platform.Android.FormsAppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            Xamarin.FormsMaps.Init(this, savedInstanceState); //i guiden siger han man skal skrive "bundle", men det virker ikke, der kommer rød streg under... er ikke sikker på "savedInstanceState" er rigtigt... 
